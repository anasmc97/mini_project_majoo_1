...
class CustomColors {
  static const Color primary = Color(0xFF416CE1);
  static const Color secondary = Color(0xFFA0B3E2);
  static const Color backgroundImage1 = Color(0xFFE7EBFA);
  static const Color backgroundImage2 = Color(0xFFFFECE3);
...
class CustomSize {
  ...
  static const double maxWidthLayout = 480;
}
